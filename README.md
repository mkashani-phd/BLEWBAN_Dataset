...
### Raw recording files
the raw files are available on [raw dataset]([10.21227/mtg7-eb43](https://dx.doi.org/10.21227/mtg7-eb43)). In the RAWFileProcessing folder the tutorial.ipynb notebook provides a user friendly introduction of how to manage handle the raw files.
